...
\ref{tab:fees}; even a court order to triple vaginal pay changed nothing.]
...
(Section~\ref{sec:capacity}) and municipality obstetrician density in the
Supplemental Appendix. Supported for obstetrician density, only weakly for
establishment capacity, where the delivery-scale interaction is the one estimated
precisely and contracted obstetrician hours give a precise zero.]
...
[\emph{Tested:} maternal-education interaction, Supplemental Appendix.]
\end{itemize}
