...
%   Appendix A: the model (via \input{model})
...
labor-assistance code (31309038). In SINASC, the sector of a birth is the legal
nature of its establishment in the CNES registry: for-profit private (codes
2xxx), nonprofit (3xxx), and public (1xxx); the headline private-public contrast
compares for-profit private with public. Because a TISS event can bundle several
...
length of stay, which reproduces the regulator's published figure. All files are
...
delivery-type field.
\item \textbf{Sector (private / nonprofit / public)}: the sector of the birth
establishment, from the legal nature of its CNES record; \textbf{private} denotes
for-profit private establishments (2xxx), the headline group.
