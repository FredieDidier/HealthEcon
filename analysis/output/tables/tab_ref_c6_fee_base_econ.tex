...
\begin{table}[H]
   \caption{\label{tab:fee_base_econ} The fee-gap null does not depend on the endogenous labor-assistance hours}
   \centering
\small\setlength{\tabcolsep}{4pt}\resizebox{\ifdim\width>\linewidth \linewidth\else\width\fi}{!}{%
   \begin{tabular}{lcccc}
      ...
      Dependent Variable: & \multicolumn{4}{c}{Private cesarean rate}\\
                                         & Base, state FE & Base, muni FE  & Economic, state FE & Economic, muni FE \\   
      Model:                             & (1)            & (2)            & (3)                & (4)\\  
      \midrule
      \emph{Variables}\\
